...
function create(filePath, name) {
  ...
  openFileByVSCode(`${paths[0]}/index.html`);
}
...
function updateReadme(filePath, name) {
  ...
  readme += `\n|\`${filePath}|${name}\`|[简单版](${site}/alpha/${filePath})、[标准版](${site}/standard/${filePath})、[测试版](${site}/beta/${filePath})|[简单版](${site}/tree/main/alpha/${filePath})、[标准版](${site}/tree/main/standard/${filePath})、[测试版](${site}/tree/main/beta/${filePath})| Todo | Todo |`
