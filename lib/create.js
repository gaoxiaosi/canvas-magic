...
function updateReadme(filePath, name) {
  ...
  readme += `\n|${filePath}|${name}|[简单](${site}/alpha/${filePath})、[标准](${site}/standard/${filePath})、[测试](${site}/beta/${filePath})|[简单](${site}/tree/main/alpha/${filePath})、[标准](${site}/tree/main/standard/${filePath})、[测试](${site}/tree/main/beta/${filePath})| Todo | Todo |`
