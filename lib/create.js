...
function updateReadme(filePath, name) {
  ...
  readme += `\n|${filePath}|${name}|[简单](${site}/alpha/${filePath})、[标准](${site}/standard/${filePath})、[测试](${site}/beta/${filePath})|[简单](${site}/blob/main/alpha/${filePath}/index.js)、[标准](${site}/blob/main/standard/${filePath}/index.js)、[测试](${site}/blob/main/beta/${filePath}/index.js)| Todo | Todo |`
