...
let u=document.createElement("button");u.innerText="悔棋",u.style.cssText="display: block; position: absolute; left: 10px; top: 10px; padding: 15px 30px; font-size: 20px; cursor: pointer;";// document.body.appendChild(regretBtn);
