...
drawButtons(){let{canvas:e,ctx:t,H:a,W:n,btnTextColor:r,primaryColor:l,onSuccess:i,onCancel:o,titleH:c,titleBtnSpacing:s,successBtnText:d,cancelBtnText:h,btnH:f,btnPadding:p,btnSpacing:m}=this;// 设置按钮样式（需提前设置字体大小，这样通过measureText方法计算文本内容的宽度）
t.font=`${f-2*p}px Arial`,t.textBaseline="top",t.textAlign="left";let g=t.measureText(d).width+2*p,u=t.measureText(h).width+2*p,x=(a+c+s)/2-f/2,v=(n-g-u-m)/2,E=v+g+m,H=[v,v+g,x,x+f],S=[E,E+u,x,x+f];// 取消按钮所占矩形范围（左右X的范围，上下Y的范围）
// 绘制成功和取消按钮
t.fillStyle=l,t.fillRect(v,x,g,f),t.fillRect(E,x,u,f),t.fillStyle=r,t.fillText(d,v+p,x+p),t.fillText(h,E+p,x+p);// 判断坐标是否在矩形（按钮）范围之内
...
close(){this.ctx.clearRect(0,0,this.W,this.H),this.canvas.onclick=null,document.getElementById(this.canvas.id).remove()}}}),l("dRo73").register(new URL("",import.meta.url).toString(),JSON.parse('["jVlne","index.7fff9846.js","2vMQB","../../1.1c79e02e.png","jgh6g","../../2.77821e30.png","670nB","../../3.12cc791a.png","fx6Vo","../../4.70762dd7.png","knvah","../../5.83ae63bf.png","ixghU","../../6.a63dd41d.png","bdmag","../../7.ee8a74b7.jpg","5zXnb","../../8.de58636c.jpg","1mHI9","../../9.cb86a63b.png","kcZvl","../../10.ae789f3c.jpg"]'));var o={};o=new URL("../../1.1c79e02e.png",import.meta.url).toString();var c={};c=new URL("../../2.77821e30.png",import.meta.url).toString();var s={};s=new URL("../../3.12cc791a.png",import.meta.url).toString();var d={};d=new URL("../../4.70762dd7.png",import.meta.url).toString();var h={};h=new URL("../../5.83ae63bf.png",import.meta.url).toString();var f={};f=new URL("../../6.a63dd41d.png",import.meta.url).toString();var p={};p=new URL("../../7.ee8a74b7.jpg",import.meta.url).toString();var m={};m=new URL("../../8.de58636c.jpg",import.meta.url).toString();var g={};g=new URL("../../9.cb86a63b.png",import.meta.url).toString();var u={};u=new URL("../../10.ae789f3c.jpg",import.meta.url).toString();var x=l("8PRdk");const v=125,E=4*v+100,H=4*v+100,S="#C2B4A5",A=6,w=[/*@__PURE__*/t(o),/*@__PURE__*/t(c),/*@__PURE__*/t(s),/*@__PURE__*/t(d),/*@__PURE__*/t(h),/*@__PURE__*/t(f),/*@__PURE__*/t(p),/*@__PURE__*/t(m),/*@__PURE__*/t(g),/*@__PURE__*/t(u)],// VALUES = [ // 线上图片地址（可在浏览器中设置“不要缓存”和“限制网速”进行调试）
...
/** @type {HTMLCanvasElement} */let b=document.createElement("canvas"),F=b.getContext("2d");b.width=E,b.height=H,b.style.cssText="position: absolute; inset: 0; margin: auto;",document.body.appendChild(b),document.body.style.backgroundColor="#F9F7EB";let y=Array.from({length:4},()=>[,,,,].fill(-1)),T=0,C=!1,B=[],k=[],M=[],U=[],L=[],D=Array(w.length).fill(!1);// 记录图片是否加载完毕
document.addEventListener("keydown",e=>{if(C)return;let t=$[e.key];t&&P(t,y,e.key)});const P=async(e,t,a)=>{B=[],k=[],M=[],U=[];let n=e(JSON.parse(JSON.stringify(t)),a);if(n.toString()===t.toString())return;y=n;let r=await I(B,k,a);if(cancelAnimationFrame(r),M.length>0){let e=j[a];M=M.map(({index:t,end:a,val:n})=>e(t,a,n)),U=U.map(({index:t,end:a,val:n})=>e(t,a,n));let t=await O(M,U,q,.3,128);cancelAnimationFrame(t)}V()},j={ArrowUp:(e,t,a,n=0)=>({x:e,y:3-t-n,val:a}),ArrowDown:(e,t,a,n=0)=>({x:e,y:t+n,val:a}),ArrowLeft:(e,t,a,n=0)=>({x:3-t-n,y:e,val:a}),ArrowRight:(e,t,a,n=0)=>({x:t+n,y:e,val:a})},I=(e,t,a,n=_)=>new Promise(r=>{let l=null,i=null,o=[],c=null,s=j[a];t=t.map(({index:e,end:t,val:a})=>s(e,t,a));let d=a=>{l||(l=a),F.clearRect(0,0,E,H),et(),K(y),t.forEach(({x:e,y:t,val:a})=>Y(e,t,a)),o.forEach(({x:e,y:t,val:a})=>Y(e,t,a)),(i=a-l)<n?(// activeGroup = moveGroup.map(({ index, start, val, distance }) => getMovePos(index, start, val, distance * elapsed / duration)); // 匀速
    o=e.map(({index:e,start:t,val:a,distance:r})=>s(e,t,a,r*Math.sin(i/n*Math.PI/2))),requestAnimationFrame(d)):r(c)};c=requestAnimationFrame(d)}),O=(e,t,a,n,r)=>new Promise(l=>{let i=null,o=null,c=null,s=0,d=h=>{i||(i=h),F.clearRect(0,0,E,H),et(),K(y),t.forEach(({x:e,y:t,val:a})=>Y(e,t,a)),e.forEach(({x:e,y:t,val:a})=>Y(e-s/2,t-s/2,a,v+v*s)),(o=h-i)<r?(// scaleRatio = (1 - Math.abs(1 - elapsed / duration * 2)) * maxScaleRatio
    s=a(o/r,n),requestAnimationFrame(d)):l(c)};c=requestAnimationFrame(d)}),q=(e,t)=>Math.sin(e*Math.PI)*t,N=(e,t)=>-Math.cos(e*Math.PI/2)*t,W=(e,t)=>{let a=[],n=!1,r=e.length;for(let l=r-1;l>=0;l--)-1!==e[l]&&(n&&e[l]===a[0]?(T=Math.max(++a[0],T),n=!1,M.push({index:t,val:e[l],end:r-a.length}),U.pop()):(a.unshift(e[l]),U.push({index:t,val:e[l],end:r-a.length}),n=!0),0==r-a.length-l?k.push({index:t,val:e[l],end:l}):B.push({index:t,val:e[l],start:l,distance:r-a.length-l}));return Array(r-a.length).fill(-1).concat(a)},J=e=>e[0].map((t,a)=>e.map(e=>e[a])),$={ArrowUp:e=>e.map((e,t)=>W(e.reverse(),t).reverse()),ArrowDown:e=>e.map((e,t)=>W(e,t)),ArrowLeft:e=>J(J(e).map((e,t)=>W(e.reverse(),t).reverse())),ArrowRight:e=>J(J(e).map((e,t)=>W(e,t)))},V=async()=>{if(X())C=!0,Z("你赢了!");else{let e=[];y.forEach((t,a)=>t.forEach((t,n)=>-1!==t&&e.push({x:a,y:n,val:t})));let{x:t,y:a}=er(y),n=.5>Math.random()?0:1;y[t][a]=n,z()&&(C=!0,Z("你输了")),await O([{x:t,y:a,val:n}],e,N,.3,256)}F.clearRect(0,0,E,H),et(),ee(y)},X=()=>T===w.length-1,z=()=>!y.some((e,t)=>e.some((a,n)=>-1===a||a===e[n+1]||a===y[t+1]?.[n])),Q=async()=>{w.forEach((e,t)=>{if(D[t])return;// 重新开始游戏时，如果已经加载过的图片不要再请求
let a=new Image;a.src=e,L[t]=a,a.onload=()=>{D[t]=!0,y.forEach((e,a)=>e.forEach((e,n)=>e===t&&Y(a,n,e)))}});let e=[];for(let t=0;t<2;t++){let{x:t,y:a}=er(y),n=.5>Math.random()?0:1;y[t][a]=n,e.push({x:t,y:a,val:n})}await O(e,[],N,.3,256),// 爱心的点位，记得将行和列改成5*5，在全局变量处改：ROWS = 5, COLUMNS = 5
// let scaleGroup = [];
...
et(),ee(y)},Y=(e,t,a,n=v)=>{e=e*(20+v)+20,t=t*(20+v)+20,D[a]?(F.save(),en(e,t,n,n,6,S),F.clip(),F.drawImage(L[a],e,t,n,n),F.restore()):en(e,t,n,n,6,R[a])},Z=e=>new x.default({canvas:b,onSuccess:G,maskColor:"rgba(143, 122, 102, 0.5)",primaryColor:"#EDA166",textTitle:e}),G=()=>{C=!1,y=Array.from({length:4},()=>[,,,,].fill(-1)),T=0,B=[],k=[],M=[],U=[],Q()},K=e=>e.forEach((e,t)=>e.forEach((e,a)=>ea(t,a))),ee=e=>e.forEach((e,t)=>e.forEach((e,a)=>{ea(t,a),-1!==e&&Y(t,a,e)})),et=()=>en(0,0,E,H,6,"#AD9D8F"),ea=(e,t,a=S,n=v)=>en(e*(20+v)+20,t*(20+v)+20,n,n,6,a),en=(e,t,a,n,r=A,l)=>{F.beginPath(),F.moveTo(e+r,t),F.arcTo(e+a,t,e+a,t+n,r),F.arcTo(e+a,t+n,e,t+n,r),F.arcTo(e,t+n,e,t,r),F.arcTo(e,t,e+a,t,r),F.closePath(),l&&(F.fillStyle=l,F.fill())},er=e=>{let t=[];return e.forEach((a,n)=>a.forEach((a,r)=>-1===e[n][r]&&t.push({x:n,y:r}))),t[Math.floor(Math.random()*t.length)]};window.onload=Q;