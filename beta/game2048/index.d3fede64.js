...
t.font=`${f-2*p}px Arial`,t.textBaseline="top",t.textAlign="left";let u=t.measureText(h).width+2*p,x=t.measureText(d).width+2*p,g=(a+c+s)/2-f/2,v=(n-u-x-m)/2,w=v+u+m,E=[v,v+u,g,g+f],y=[w,w+x,g,g+f];// 取消按钮所占矩形范围（左右X的范围，上下Y的范围）
// 绘制成功和取消按钮
