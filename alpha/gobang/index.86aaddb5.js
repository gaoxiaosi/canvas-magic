...
const i=(t,l,o,r,i=1,n="#000000")=>{e.lineWidth=i,e.strokeStyle=n,e.beginPath(),e.moveTo(50*t+50,50*l+50),e.lineTo(50*o+50,50*r+50),e.stroke()},n=(t,l,o)=>{e.beginPath(),e.arc(50*t+50,50*l+50,20,0,2*Math.PI),e.closePath(),e.fillStyle=o?"black":"white",e.fill()},a=(t,e,l,o)=>{for(let[r,i]of[[1,0],[0,1],[1,1],[1,-1]]){let n=1,a=0,f=0;for(;n<5&&o[t+r*++a]?.[e+i*a]===l;)n++;for(;n<5&&o[t-r*++f]?.[e-i*f]===l;)n++;if(5===n)return!0}return!1};window.onload=()=>{e.fillStyle="#E4A751",e.fillRect(0,0,800,800);for(let t=0;t<15;t++)i(0,t,14,t),i(t,0,t,14)}// ES6防抖函数
;